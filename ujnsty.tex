\usepackage{pdfpages, setspace, graphicx, dashrule, booktabs}
...
\usepackage[scale = 1, angle = 90, color = black, hshift = 15pt, vshift = 9cm]{background}
...
\newenvironment{ujnabstract}{
	\setfancylength
	\ctexset{section/numbering = false}
}{}

\newenvironment{ujnabstract*}{\ctexset{section/numbering = false}}{}
